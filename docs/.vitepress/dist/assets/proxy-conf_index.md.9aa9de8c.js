...
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div><h2 id="\u4EE3\u7406-https-\u5230-http" tabindex="-1">\u4EE3\u7406 HTTPS \u5230 HTTP <a class="header-anchor" href="#\u4EE3\u7406-https-\u5230-http" aria-hidden="true">#</a></h2><p><code>default.conf</code>\uFF1A\u914D\u7F6E\u6587\u4EF6<br><code>backendserver-address</code>\uFF1A\u6307\u5B9A\u670D\u52A1\u5668\u5730\u5740\u6216\u8005\u670D\u52A1\u540D</p><div class="language-sh"><button class="copy"></button><span class="lang">sh</span><pre><code><span class="line"><span style="color:#676E95;"># Use this example for proxy HTTPS traffic to the document server running at &#39;backendserver-address&#39;.</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">}</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div><h2 id="\u4EE3\u7406\u865A\u62DF\u8DEF\u5F84" tabindex="-1">\u4EE3\u7406\u865A\u62DF\u8DEF\u5F84 <a class="header-anchor" href="#\u4EE3\u7406\u865A\u62DF\u8DEF\u5F84" aria-hidden="true">#</a></h2><p>\u5F53\u60A8\u9700\u8981\u5C06\u4E3B\u673A\u4E0A\u7684\u67D0\u4E2A\u76EE\u5F55\u6620\u5C04\u5230 Web \u670D\u52A1\u5668\u4E2D\u6307\u5B9A\u7684\u8DEF\u5F84\u65F6\uFF0C\u8FD9\u662F\u4E00\u4E2A\u5408\u9002\u7684\u573A\u666F\uFF1A <code>default.conf</code>\uFF1A\u914D\u7F6E\u6587\u4EF6<br><code>backendserver-address</code>\uFF1A\u6307\u5B9A\u670D\u52A1\u5668\u5730\u5740\u6216\u8005\u670D\u52A1\u540D</p><div class="language-sh"><button class="copy"></button><span class="lang">sh</span><pre><code><span class="line"><span style="color:#676E95;">#Use this example for the proxy document server running at &#39;backendserver-address&#39;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">}</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div><h2 id="\u4E0E\u5E94\u7528\u96C6\u6210-\u540C\u57DF\u8BBF\u95EE" tabindex="-1">\u4E0E\u5E94\u7528\u96C6\u6210 (\u540C\u57DF\u8BBF\u95EE) <a class="header-anchor" href="#\u4E0E\u5E94\u7528\u96C6\u6210-\u540C\u57DF\u8BBF\u95EE" aria-hidden="true">#</a></h2><p>\u5047\u8BBE\u4F60\u5DF2\u7ECF\u6709\u4E00\u4E2A\u5E94\u7528\u5730\u5740\u4E3A <code>https://www.A.com</code>\uFF0C\u540C\u65F6\u60F3\u628A\u7F16\u8F91\u5668\u90E8\u7F72\u5728\u8FD9\u4E2A\u57DF\u540D\u4E0B\uFF0C\u8FD9\u662F\u4E00\u4E2A\u5408\u9002\u7684\u573A\u666F\uFF1A</p><p><code>https://www.A.com/7.4.0-163/web-apps/apps/api/documents/api.js</code></p><div class="language-sh"><button class="copy"></button><span class="lang">sh</span><pre><code><span class="line"><span style="color:#676E95;"># backendserver-address \u6362\u6210\u4F60\u7684\u670D\u52A1\u540D\u6216\u8005\u5730\u5740</span></span>
<span class="line"><span style="color:#A6ACCD;">upstream docservice </span><span style="color:#89DDFF;">{</span></span>
<span class="line"><span style="color:#A6ACCD;">  server backendserver-address</span><span style="color:#89DDFF;">;</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#A6ACCD;">proxy_set_header Upgrade </span><span style="color:#89DDFF;">$</span><span style="color:#A6ACCD;">http_upgrade</span><span style="color:#89DDFF;">;</span></span>
<span class="line"><span style="color:#A6ACCD;">proxy_set_header Connection </span><span style="color:#89DDFF;">$</span><span style="color:#A6ACCD;">proxy_connection</span><span style="color:#89DDFF;">;</span></span>
<span class="line"><span style="color:#A6ACCD;">proxy_set_header X-Forwarded-Host </span><span style="color:#89DDFF;">$</span><span style="color:#A6ACCD;">the_host/7.4.0-163</span><span style="color:#89DDFF;">;</span></span>
<span class="line"><span style="color:#A6ACCD;">proxy_set_header X-Forwarded-Proto </span><span style="color:#89DDFF;">$</span><span style="color:#A6ACCD;">the_scheme</span><span style="color:#89DDFF;">;</span></span>
<span class="line"><span style="color:#A6ACCD;">proxy_set_header X-Forwarded-For </span><span style="color:#89DDFF;">$</span><span style="color:#A6ACCD;">proxy_add_x_forwarded_for</span><span style="color:#89DDFF;">;</span></span>
<span class="line"></span>
<span class="line"></span>
